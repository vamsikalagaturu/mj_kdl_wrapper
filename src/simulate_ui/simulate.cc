...
void UpdateWrapperRealtimeFactor(mj::Simulate* sim) {
  ...
  sim->ui0.sect[SECT_SIMULATION].item[12].multi.nelem = 1;
  mju::strcpy_arr(sim->ui0.sect[SECT_SIMULATION].item[12].multi.name[0], label);
  mjui_update(SECT_SIMULATION, 12, &sim->ui0, &sim->uistate, &sim->platform_ui->mjr_context());
}
...
void UpdateWrapperRecorderState(mj::Simulate* sim) {
  ...
  sim->ui0.sect[SECT_SIMULATION].item[20].multi.nelem = 1;
  mju::strcpy_arr(sim->ui0.sect[SECT_SIMULATION].item[20].multi.name[0], label);
...
void UpdateWrapperRecordCameraList(mj::Simulate* sim, const mjModel* m) {
  ...
  mjui_update(SECT_SIMULATION, 15, &sim->ui0, &sim->uistate, &sim->platform_ui->mjr_context());
}
