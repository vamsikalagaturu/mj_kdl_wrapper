...
- `src/examples/mjcf/ex_gripper.cpp` -- single arm + gripper torque control
- `src/examples/mjcf/ex_impedance.cpp` -- Cartesian impedance with gripper
- `src/examples/mjcf/ex_dual_arm.cpp` -- two arms, each with gripper
