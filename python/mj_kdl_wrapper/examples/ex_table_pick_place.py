...
def main() -> int:
    ...
    try:
        ...
        phases = [
            ...
            Phase("CLOSE", waypoints["pick"], 1.5, 2.5, -1.0, GRIPPER_CLOSED),
            Phase("LIFT", waypoints["lift"], 3.0, 5.0, 0.08, GRIPPER_CLOSED),
            Phase("PLACE_ABOVE", waypoints["place_above"], 3.0, 5.0, 0.08, GRIPPER_CLOSED),
            Phase("PLACE", waypoints["place"], 5.0, 8.0, 0.03, GRIPPER_CLOSED),
            Phase("OPEN", waypoints["place"], 1.0, 2.0, -1.0, 0.0),
            Phase("RETREAT", waypoints["place_above"], 2.0, 4.0, 0.08, 0.0),
            Phase("HOLD", waypoints["place_above"], 1.0, 0.0, -1.0, 0.0),
        ]
        if args.gui:
